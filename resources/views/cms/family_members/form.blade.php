                  ...
                  <div class="profile_img" class="col-md-6 col-sm-9 col-xs-12">
                    ...
                    <div id="crop-avatar">
                      ...
                      <div class="avatar-view" title="Change the avatar">
                        <img src="{!!asset('images/families-members/generic.png')!!}" alt="Avatar">
                      </div>
                      ...
                      <div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            {!!Form::open(['route'=>'families_members.picture','method'=>'POST', 'class'=>'avatar-form', 'enctype'=>'multipart/form-data'])!!}
                              ...
                              <div class="modal-body">
                                <div class="avatar-body">
                                  ...
                                  <div class="avatar-upload">
                                    <input class="family_member_id" name="family_member_id" type="hidden" value="{!!$gc->entity_to_edit->id!!}">
