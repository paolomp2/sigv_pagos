            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  {!!Form::open(['route'=>$gc->url_base.'.add_store_students','method'=>'POST', 'class'=>'form-horizontal form-label-left'])!!}           
                    
                    <input id="id_group" name="id_group" type="hidden" value="{!!$gc->entity_to_edit->id!!}">
                    <input id="studients_ids" name="studients_ids" type="hidden" value="">
                    
                    <input hidden type="text" id="num_remainings_students" name="num_remainings_students"  value="1000">
...
<!-- select2 -->
  <script>
    ...
    $('#table_students').on('click', '.delete', function(e) {
      ...
      num_students.value = parseInt(num_students.value) - 1;
      //modifing the title table
      var new_title = "Se están agregando "+num_students.value+" alumnos. DEBE DAR CLICK EN 'Registrar todos los alumnos' PARA CONFIRMAR";
      document.getElementById("title_table_students").innerHTML = new_title; 
      //removing the row
