    ...
    <div id="wrapper">
      <div id="login" class="animate form">
        <section class="login_content">
          {!!Form::open(['route'=>'auth.store','method'=>'POST', 'class'=>'form-horizontal form-label-left'])!!}
            <h1>SIGC</h1>
            {!! csrf_field() !!}
            <div>
            ...
            <div class="separator">
              ...
              <br />
              <div>
                <h1><i class="fa fa-mortar-board" style="font-size: 26px;"></i> Sistema Integral de Gestión de Colegios</h1>
